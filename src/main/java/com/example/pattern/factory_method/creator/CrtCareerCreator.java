package com.example.pattern.factory_method.creator;

import com.example.pattern.factory_method.product.ConcreteProductCrtCareer;
import com.example.pattern.factory_method.product.Product;
